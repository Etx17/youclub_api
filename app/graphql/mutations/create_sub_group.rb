module Mutations
  class CreateSubGroup < BaseMutation
    ...
    def resolve(activity_id:, name: nil, min_price:, class_type: nil, short_description: nil, subscription_by_reccurence_price: nil, tarifications: nil)
      sub_group = SubGroup.create!(
        ...
        subscription_by_reccurence_price: subscription_by_reccurence_price ? (subscription_by_reccurence_price * 100).round : nil,
